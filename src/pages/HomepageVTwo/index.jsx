          ...
          <div className="overflow-auto overflow-x-auto w-full">
            <div className="h-[750px] sm:h-[950px] md:px-5 relative w-full">
              ...
              <div className="absolute bottom-[4%] gap-4 grid sm:grid-cols-1 md:grid-cols-3 grid-cols-6 items-center justify-center right-[0] shadow-bs w-auto">
                <div className="bg-white-A700 flex flex-col h-40 items-center justify-end p-[34px] sm:px-5 w-[160]">
                ...
                <div className="bg-white-A700 flex flex-col h-40 items-center justify-end p-[30px] sm:px-5 w-[160]">
                ...
                <div className="bg-gray-800 flex flex-col h-40 items-center justify-end p-[30px] sm:px-5 w-[160]">
                  <div className="flex flex-col gap-4 items-center justify-start w-auto">
                    <Img
                      className="h-7 w-[70%]"
                ...
                <div className="bg-white-A700 flex flex-col h-40 items-center justify-end p-[31px] sm:px-5 w-[160]">
